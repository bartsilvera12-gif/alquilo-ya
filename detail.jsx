...
function DetailPage({ p, onProperty, onNav }) {
  ...
  return (
    <div className="fade-in">
      ...
      <Gallery photos={p.photos} active={active} setActive={setActive} />
      <div className="container" style={{ padding: '32px', display: 'grid', gridTemplateColumns: '1fr 380px', gap: 40, alignItems: 'flex-start' }}>
        ...
        <div style={{ position: 'sticky', top: 92 }}>
          <AgentCard agent={p.agent} price={p.price} tipo={p.tipo}/>
        </div>
      </div>
...
function Gallery({ photos, active, setActive }) {
  return (
    <div className="container" style={{ padding: '8px 32px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '2.2fr 1fr 1fr', gridTemplateRows: '230px 230px', gap: 8, borderRadius: 16, overflow: 'hidden' }}>
        <Photo src={photos[0]} style={{ gridRow: '1 / 3', borderRadius: 0 }}/>
        <Photo src={photos[1]} style={{ borderRadius: 0 }}/>
        <Photo src={photos[2]} style={{ borderRadius: 0 }}/>
        <Photo src={photos[3]} style={{ borderRadius: 0 }}/>
        <div style={{ position: 'relative' }}>
          <Photo src={photos[4]} style={{ borderRadius: 0, height: '100%' }}/>
          <button style={{
      ...
      <div className="row between" style={{ marginTop: 12 }}>
        ...
        <button className="btn btn-outline btn-sm">Ver galería completa <I.arrow s={14}/></button>
      </div>
    </div>
  );
}
...
function AgentCard({ agent, price, tipo }) {
  return (
      ...
      <div className="row gap-12">
        ...
        <div style={{ flex: 1 }}>
          ...
          <div className="row gap-4" style={{ color: 'var(--yellow)', marginTop: 4 }}>
            ...
            <span style={{ fontSize: 11, color: 'var(--ink-3)', marginLeft: 4 }}>4.9 · 28 reseñas</span>
          </div>
        </div>
      </div>
